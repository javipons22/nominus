...
try {
    ...
    //Recipients
    $mail->setFrom('administracion@nominusagencia.com', 'Formulario Nominus');
    $mail->addAddress('administracion@nominusagencia.com', 'Info Nominus');
    ...
    $mail->Subject = 'Nuevo contacto desde el formulario de NOMINUS';
    $mail->Body    = '<h2>Nuevo contacto desde el formulario de NOMINUS</h2>'
    ...
    $status = $mail->send();
    if(!$status) {
        echo'<script>window.location.href="https://nominusagencia.com/?error=true"; </script>';
        exit();
    } else {
        echo'<script>window.location.href="https://nominusagencia.com/?error=false"; </script>';
        exit();
    }
} catch (Exception $e) {
